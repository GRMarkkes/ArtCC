...
export declare const networks: {
    readonly futurenet: {
        ...
        readonly contractId: "CACPJOTDGFBGFOOIGQ4H2CTWL75XBEYRHDBO3IHM7XLF22MPHFPW2SND";
    };
};
/**
...
*/
    createCampaign: ({ owner_addr, title_cmp, desc_cmp, category_cmp, main_location_cmp, date_cmp, image_cmp, target_cmp, deadline_cmp }: {
        owner_addr: string;
        title_cmp: string;
        desc_cmp: string;
        category_cmp: string;
