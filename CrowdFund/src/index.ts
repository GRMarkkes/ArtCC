...
export class Contract {
    ...
    */
    createCampaign = async ({owner_addr, title_cmp, desc_cmp, category_cmp, main_location_cmp, date_cmp, image_cmp, target_cmp, deadline_cmp}: {owner_addr: string, title_cmp: string, desc_cmp: string, category_cmp: string, main_location_cmp: string, date_cmp: string, image_cmp: string, target_cmp: i128, deadline_cmp: u64}, options: {
        /**
         * The fee to pay for the transaction. Default: 100.
         */
        fee?: number,
