...
impl CrowdFund {
    ...
    pub fn donate_to_campaign(
        ...
        let artist_amount = ((amount * ARTIST_PER) / 100) * 10000000;
        let launchpad_amount = ((amount * LAUNCHPAD_PER) / 100) * 10000000;
        let dev_amount = ((amount * DEV_PER) / 100) * 10000000;
