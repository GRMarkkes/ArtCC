...
function SorobanReactProvider({ appName, autoconnect = false, chains, children, connectors, }) {
    ...
    const [mySorobanContext, setSorobanContext] = react_1.default.useState(Object.assign(Object.assign({}, _1.defaultSorobanContext), { appName,
        ...
        chains,
        connectors,
        activeConnector, activeChain: chains.length == 1 ? chains[0] : undefined, connect: () => __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
