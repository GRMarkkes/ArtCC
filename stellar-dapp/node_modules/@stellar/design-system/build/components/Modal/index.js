...
var ModalHeading = function (_a) {
    ...
    return (_jsx(Heading, __assign({ as: "h2", size: "md", className: "ModalHeading" }, { children: children })));
};
...
export var Modal = function (_a) {
    ...
    return ReactDOM.createPortal(_jsxs("div", __assign({ className: "Modal", style: customStyle }, (alignToBottom ? { "data-modal-align": "bottom" } : {}), { children: [_jsxs("div", __assign({ className: "Modal__container" }, { children: [_jsx("div", __assign({ className: "Modal__content" }, { children: children })), _jsx("div", __assign({ className: "Modal__close" }, { children: _jsx(NavButton, { id: "modal-close-button", title: "Close modal", onClick: onClose, icon: _jsx(Icon.Close, {}) }) }))] })), _jsx("div", { className: "Modal__background", role: "button", onClick: onClose })] })), parent);
};
