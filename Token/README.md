...
```json
"scripts": {
  "postinstall": "soroban contract bindings ts --rpc-url https://mainnet.stellar.validationcloud.io/v1/TfG9-m1TsFivRBylmjcE2Xw_GeWb9yV7wOcx1MgilH4 --network-passphrase \"Public Global Stellar Network ; September 2015\" --id CAMPH7W5NXSV643YAQTJX6O76G6DGSEL6TWB2HOB6QCHXALN67ZUQTHP --name token-binding"
}
```
