...
*/
    initialize = async ({ admin, decimal, name, symbol, account, amount }, options = {}) => {
        return await assembled_tx_js_1.AssembledTransaction.fromSimulation({
            method: 'initialize',
            args: this.spec.funcArgsToScVals("initialize", { admin: new stellar_sdk_1.Address(admin), decimal, name, symbol, account: new stellar_sdk_1.Address(account), amount }),
            ...options,
            ...this.options,
