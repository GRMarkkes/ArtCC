...
export const networks = {
    futurenet: {
        ...
        contractId: "CBBVJYS2FKGI5CLMCBNRB62IOTE7ZTMVABBOGZFUOSN7AETXAGXPU2XZ",
    }
} as const
...
export class Contract {
    ...
    async initialize<R extends ResponseTypes = undefined>({admin, decimal, name, symbol, account, amount}: {admin: Address, decimal: u32, name: string, symbol: string, account: Address, amount: i128}, options: {
        /**
