...
export class Contract {
    ...
    */
    initialize = async ({admin, decimal, name, symbol, account, amount}: {admin: string, decimal: u32, name: string, symbol: string, account: string, amount: i128}, options: {
        /**
        ...
        return await AssembledTransaction.fromSimulation({
            method: 'initialize',
            args: this.spec.funcArgsToScVals("initialize", {admin: new Address(admin), decimal, name, symbol, account: new Address(account), amount}),
            ...options,
            ...this.options,
            errorTypes: Errors,
