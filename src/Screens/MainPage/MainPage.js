...
// import {BsArrowLeft,BsArrowRight} from 'react-icons'
import { CgArrowLongLeft, CgArrowLongRight, CgEnter } from 'react-icons/cg';
...
function MainPage() {
    ...
    return (
        <>
            ...
            {isWideScreen ?
                <div class="position-absolute bottom-10 start-0 translate-middle-y container-fluid pl-3" style={{ paddingLeft: 60 }}>
                    <div className={isWideScreen ? "count-bar" : "count-bar-mobile"}>
                        <h2 class="text-center text-sm-start text-md-center text-lg-start">OVERVIEW</h2>
                        <div class="border-white border-1 h-50 border-end "></div>
                ...
                : <div class="position-absolute bottom-10 start-0 translate-middle-y container-fluid pl-3" style={{ marginTop: 40 }}>
            ...
            {isWideScreen ?
                ...
                <div class="container-fluid d-flex flex-wrap" style={{ marginTop: 181, padding: 0 }}>
                    <div class="col-12 col-md-6" style={{ width: '100%', paddingLeft: 30, paddingRight: 30 }}>
                    ...
                    <div class="col-12 col-md-6" style={{ paddingLeft: 0, margin: 0, width: '100%' }}>
                        <img src={Portfolio_image_mobile} class="img-fluid" alt="Portfolio_Image" style={{ margin: 0 }} />
                    </div>
                </div>}
            {isWideScreen ?
                <div style={{ display: 'flex', flexDirection: 'row', marginTop: 181, width: '100%', }}>
                ...
                <div class="container-fluid d-flex flex-wrap" style={{ padding: 0 }}>
                    <div class="col-12 col-md-6" style={{ width: '100%', paddingLeft: 30, paddingRight: 30 }}>
                    ...
                    <div class="col-12 col-md-6" style={{ paddingLeft: 0, margin: 0, width: '100%' }}>
                        <img src={Netflix_image} class="img-fluid" alt="Portfolio_Image" style={{ margin: 0 }} />
                    </div>
                </div>}
            {isWideScreen ?
                ...
                <div class="container-fluid d-flex flex-wrap" style={{ padding: 0, backgroundColor: 'black' }}>
                    <div class="col-12 col-md-6" style={{ width: '100%', paddingLeft: 30, paddingRight: 30, color: 'white' }}>
                    ...
                    <div class="col-12 col-md-6" style={{ paddingLeft: 0, margin: 0, width: '100%' }}>
                        <img src={Art_Credit} class="img-fluid" alt="Portfolio_Image" style={{ margin: 0 }} />
                    </div>
                </div>}
