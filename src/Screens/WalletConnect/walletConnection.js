...
function walletconnection() {
  return (
    <div
      class="main-container w-100 vh-100"
      style={{
    ...
    >
      <div
        class="child-container d-flex justify-content-center align-items-center flex-column bg-black position-absolute top-50 start-50 translate-middle vw-60"
        style={{ zIndex: 1, height:'60%' }}
      >
        <p class="fs-5 fw-bold text-white">CONNECT YOUR WALLET </p>
        <p className="text-white">Select a wallet or log in with email</p>
        <button class="btn btn-dark m-2 w-95">
          <img
            src={wallet_icon}
            alt="Button Image"
            className="me-2"
